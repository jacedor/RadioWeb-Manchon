...
$(document).on("click", "#visorJpeg", function () {
    var filaActiva = $("#tblSolicitudes tbody tr.ACTIVA");
    var oidExploracion = filaActiva.data('oidexploracion');
    if (oidExploracion === undefined || oidExploracion === null) {
        oidExploracion = $("#OIDVISORQREPORT").val();
    }
...
function comprobarEstadoQreport(oidExploracion) {
    
    $("#OIDVISORQREPORT").val(oidExploracion);
...
$(document).on("click", "#btnImprimir", function myfunction() {
    ...
    var filaActiva = $("#tblCitaCreada* .ACTIVA");
    var oidExploracion = $("#citaCreadaOid").val();// filaActiva.data('oid');
...
function imprimirDocumento(oidExploracion, oidTipoDocumento) {
