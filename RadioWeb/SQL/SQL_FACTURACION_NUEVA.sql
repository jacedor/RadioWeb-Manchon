...
BEGIN
 ...
 for select 1 AS ORDEN,G.COD_GRUP,
  ...
  INTO :ORDEN,:COD_GRUP,:SANTERIOR,:PANTERIOR,:SACTUAL,:PACTUAL,:CANTERIOR,:CACTUAL,:DIFCUENTA,:DIFCUENTAPORC
 
  do begin
    INSERT INTO HFACTURACIONMENSUAL (ORDEN,COD_GRUP,SANTERIOR,PANTERIOR,SACTUAL,PACTUAL,CANTERIOR,CACTUAL,DIFCUENTA,DIFCUENTAPORC)
       VALUES (:ORDEN,:COD_GRUP,:SANTERIOR,:PANTERIOR,:SACTUAL,:PACTUAL,:CANTERIOR,:CACTUAL,:DIFCUENTA,:DIFCUENTAPORC);   
  end
  ...
  FOR SELECT ORDEN,COD_GRUP,SANTERIOR,PANTERIOR,SANTERIORCONSUM,
    ...
    ORDER BY 3,1,2
    INTO :ORDEN,:COD_GRUP,:SANTERIOR,:PANTERIOR,:SANTERIORCONSUM,:SANTERIORTOTAL,:SACTUAL,:PACTUAL,:SACTUALCONSUM,:SACTUALTOTAL,:DIFCANTIDAD,:DIFCANTIDADPORC,:CANTERIOR,:CACTUAL,:DIFCUENTA,:DIFCUENTAPORC
